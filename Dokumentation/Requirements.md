...
| 1.2 → 3.4, 3.5                 | Eine exakte Prozentberechnung (1.2) bedingt die Einhaltung der Toleranz (3.4) und muss auch bei Alterung (3.5) robust bleiben. |
...
| 1.1 → 1.2                | Die Spannung der Batterie muss zuverlässig gemessen werden (1.1), damit diese zuverlässig in Prozent umgerechnet werden kann (1.2). |
...
| 2.7 ↔ 4.4                | Nicht störende Helligkeit (2.7) kann im Widerspruch stehen zu gut wahrnehmbaren Warnungen (4.4). |
...
| 2.6, 4.4                  | Die intuitive Batteriestandsanzeige (2.6) hängt mit der guten Wahrnehmbarkeit der Warnung bei niedrigem Batteriestand (4.4) zusammen, da beide dasselbe Ziel verfolgen. Für den Nutzer gut erkennbar und leicht verständlich zu sein. |